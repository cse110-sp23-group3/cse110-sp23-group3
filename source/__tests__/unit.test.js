...
const expectedJSON = [
  {
    ...
    role: 'Team Lead',
    description:
      'Faith is a 2nd year undergraduate studying Computer Science in Sixth College. She is interested in pursuing more knowledge in design and chemistry. Her favorite animals are cheetahs and dogs. She loves to dance and also has a twin sister at UCSD!',
    profilePos: 'left',
  },
  {
    ...
    role: 'Team Lead',
    description:
      'Henry is a 2nd year studying Computer Science in Sixth College. His favorite animal is the lion and a fun fact is his middle name is his favorite animal.',
    profilePos: 'right',
  },
  {
  ...
  },
  {
    ...
    role: 'Planner',
    description:
      "Jiaen is a 2nd graduate student of UCSD's Computer Science and Engineering department. He is a cat person, coconut water lover, soccer fan and amateur football player.",
    profilePos: 'right',
  },
  {
  ...
  },
  {
    ...
    role: 'Developer',
    description:
      'Mico is a 4th year studying Computer Engineering at Muir College. His favorite animal is the Emperor Penguin. His go-to In-N-Out order is 2 4x4s Animal Style, extra tomatoes, no pickles, cut in half, with banana peppers.',
    profilePos: 'right',
  },
  {
    ...
    role: 'Developer',
    description:
      'Nick is a 4th year bioinformatics major at Revelle College. His favorite animal is the peacock. He enjoys being out in nature and playing board games with his friends from church. Although he does not endorse the practice of palm reading, he has enjoyed learning about software engineering in CSE 110.',
    profilePos: 'left',
  },
  {
    ...
    role: 'Developer',
    description:
      'Michael is a 2nd year Computer Science major in Eleanor Roosevelt College. His favorite animal is the brown bear and he has visited over 20 countries so far.',
    profilePos: 'right',
  },
  {
    ...
    role: 'Developer',
    description:
      'Greetings from Anh- a 3rd year in Revelle College. He is a Computer Science major student who hates math (not your typical Asian 😬...) but loves coding and creating amazing things with technology. Fun fact- he can rap in three languages.🎤',
    profilePos: 'left',
  },
  {
    ...
    role: 'Developer',
    description:
      "Dylan is a 3rd year Computer Science major in Muir College. His favorite animal is a dog because they are man's best friend. His hobbies outside of school-related things are playing volleyball and going to the gym.",
    profilePos: 'right',
  },
];
...
describe('loadProfiles', () => {
  it('loads valid URL and returns JSON object', async () => {
    const URL =
      'https://raw.githubusercontent.com/cse110-sp23-group3/cse110-sp23-group3/main/source/assets/json/aboutprofiles.json';
